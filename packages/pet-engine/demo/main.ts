...
const PETS: PetSpec[] = [
  ...
  spec("Obsidian", "balanced", { crown: "none", head: "cat", torso: "capsule", arms: "noodle", feet: "paws", face: "eyes" }, P.obsidian, 0.7, 0.95, "Watches. Judges. Occasionally approves."),
  ...
  spec("Rosette", "bigHead", { crown: "none", head: "cat", torso: "egg", arms: "stub", feet: "paws", face: "eyes" }, P.rose, 0.6, 1, "Extremely interested in you."),
